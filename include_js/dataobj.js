...
//            "NY.GNS.ICTR.ZS": "Gross savings (% of GDP)",
    ...
    for (var i = currentYear; i > currentYear - 50; i--) {
        indicatorYears.push(i);
    }

    return {
        getTopoToWb: function () {
            return topoToWb;
        },
        getDataObjZ: function () {
            return dataObjZ;
        },
        getWbToTopo: function () {
            return wbToTopo;
        },
        getIndicatorsSelected: function () {
            return indicatorsSelected;
        },
        getTndicatorYears: function () {
            return indicatorYears;
        }
    };
